...
while True:
    ...
    with open('ziroom.txt', 'a+') as f:
        for i in xrange(10, 9001, 10):
            ...
            headers = {'Referer': 'http://m.ziroom.com/HZ/search.html', 'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36'}
